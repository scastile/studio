                            ...
                            <div>
                             ...
                             <div>
                                ...
                                <p className="p-3 bg-muted rounded-md mt-1 font-mono text-sm">A knight in shining armor holding a sword, fantasy art.</p>
                                 <div className="mt-2 relative aspect-square w-full rounded-lg overflow-hidden border">
                                    <Image src="https://storage.googleapis.com/librarylaunchpad-default-rtdb.appspot.com/a-knight-good.png" alt="A fantasy art style knight in shining armor" fill className="object-cover" data-ai-hint="knight fantasy" />
                                </div>
                            </div>
                             <div>
